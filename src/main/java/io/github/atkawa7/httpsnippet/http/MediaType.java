...
public class MediaType {
    ...
    public  static  final List<String> MULTIPART_MEDIA_TYPES = Collections.unmodifiableList(
            Arrays.asList(MULTIPART_FORM_DATA, MULTIPART_MIXED, MULTIPART_RELATED, MULTIPART_ALTERNATIVE));
    public  static  final List<String> JSON_MEDIA_TYPES = Collections.unmodifiableList(
